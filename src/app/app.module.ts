...
import {RepositoryComponent} from "app/main/repository/repository.component";

@NgModule({
  declarations: [
    AppComponent, AppHeaderComponent, AppFooterComponent, MainComponent, MenuComponent, RepositoryComponent
  ],
  imports: [
    BrowserModule,
    FormsModule,
